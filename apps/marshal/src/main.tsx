  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="bg-pmg-navy text-white px-8 py-4 flex items-center gap-4">
        ...
        <span className="text-pmg-cyan font-semibold text-sm uppercase tracking-widest">Staff</span>
      </header>
      <main className="px-8 py-12">
        <h1 className="text-3xl font-semibold text-pmg-navy mb-2">Employee &amp; Marshal App</h1>
